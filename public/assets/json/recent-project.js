        ...
        $('#recent-project').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    "render": function(data, type, row) {
                        if (row['client'] == "1") {
                            var class_name = "badge-soft-success border border-success";
                            var status_name = "Low"
                        }
                        if (row['client'] == "2") {
                            var class_name = "badge-soft-warning border border-warning";
                            var status_name = "Medium"
                        } else {
                            var class_name = "badge-soft-danger border border-danger";
                            var status_name = "High"
                        }
