        ...
        $('#deal_list').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    "render": function(data, type, row) {
                        if (row['tag1'] == "Collab") {
                            var class_name = "badge-soft-success";
                            var status_name = "Collab"
                        } else if (row['tag1'] == "Rated") {
                            var class_name = "badge-soft-warning";
                            var status_name = "Rated"
                        } else if (row['tag1'] == "Promotion") {
                            var class_name = "badge-soft-info";
                            var status_name = "Promotion"
                        } else {
                            var class_name = "badge-soft-danger";
                ...
                },
                {
                    "render": function(data, type, row) {
                        if (row['Status'] == "0") {
                            ...
                            var class_name = "bg-purple";
                            var status_name = "open"
                        }
