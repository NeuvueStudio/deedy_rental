                ...
                <div class="col-lg-6 vh-100 overflow-y-auto overflow-x-hidden">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 mx-auto">
                            <form action="{{ route('login.attempt') }}" method="POST" class=" vh-100 d-flex justify-content-between flex-column p-4 pb-0">
                            @csrf
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <p class="mb-0">New on our platform?<a href="/register" class="link-indigo fw-bold link-hover"> Create an account</a></p>
                                    </div>
